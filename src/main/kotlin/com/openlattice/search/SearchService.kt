    ...
    fun executeEntityNeighborSearch(
        ...
        edges.forEach { edge ->
            ...
            if (entitySetsIdsToAuthorizedProps.containsKey(edgeEntitySetId)) {
                entitySetIdToEntityKeyId.getOrPut(edgeEntitySetId) { mutableSetOf() }.add(edgeEntityKeyId)
                ...
                if (entitySetsIdsToAuthorizedProps.containsKey(neighborEntitySetId)) {
                    ...
                    entitySetIdToEntityKeyId.getOrPut(neighborEntitySetId) { mutableSetOf() }.add(neighborEntityKeyId)
                }
            }
