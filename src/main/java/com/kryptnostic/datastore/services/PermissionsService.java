...
public class PermissionsService implements PermissionsManager {
    ...
    public void addPermissionsForPropertyTypeInEntityType(
        ...
        int permissionsToAdd = Permission.asNumber( permissions );
        // add Permission corresponds to bitwise or current permission, and permissionsToAdd
        setPermissionsForPropertyTypeInEntityType( role,
                entityTypeFqn,
                propertyTypeFqn,
                currentPermission | permissionsToAdd );
    }
    ...
    public void removePermissionsForPropertyTypeInEntityType(
        ...
        setPermissionsForPropertyTypeInEntityType( role,
                entityTypeFqn,
                propertyTypeFqn,
                currentPermission & ~permissionsToRemove );
    }
    ...
    private void setPermissionsForPropertyTypeInEntityType(
            String role,
            FullQualifiedName entityTypeFqn,
            FullQualifiedName propertyTypeFqn,
            int permission ) {
    ...
    private int getPermissionsForPropertyTypeInEntityType(
            String role,
            FullQualifiedName entityTypeFqn,
            FullQualifiedName propertyTypeFqn ) {
    ...
    public void addPermissionsForPropertyTypeInEntitySet(
            ...
            FullQualifiedName propertyTypeFqn,
            Set<Permission> permissions ) {
        int currentPermission = getPermissionsForPropertyTypeInEntitySet( role,
                entityTypeFqn,
                entitySetName,
                propertyTypeFqn );
    ...
    private void setPermissionsForPropertyTypeInEntitySet(
            String role,
            FullQualifiedName entityTypeFqn,
            String entitySetName,
            FullQualifiedName propertyTypeFqn,
    ...
    public boolean checkUserHasPermissionsOnPropertyTypeInEntitySet(
        ...
        if ( roles.contains( Constants.ROLE_ADMIN ) ) {
            ...
            int userPermission = getPermissionsForPropertyTypeInEntitySet( roles,
                    entityTypeFqn,
                    entitySetName,
                    propertyTypeFqn );
    ...
    private int getPermissionsForPropertyTypeInEntitySet(
            ...
            FullQualifiedName propertyTypeFqn ) {
        return roles.stream()
                .mapToInt( role -> getPermissionsForPropertyTypeInEntitySet( role,
                        entityTypeFqn,
                        entitySetName,
                        propertyTypeFqn ) )
                .reduce( 0, ( a, b ) -> a | b );
