...
import com.kryptnostic.instrumentation.v1.constants.Names;
...
public class MetricsRequestMetadata extends ObjectMetadata {
    private int receivedBlocks;

    @JsonCreator
    public MetricsRequestMetadata(
    ...
    public boolean equals( Object obj ) {
        MetricsRequestMetadata other = (MetricsRequestMetadata) obj;
