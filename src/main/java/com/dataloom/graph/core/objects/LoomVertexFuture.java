 ...
 * <li>If the transaction fails, repeat step 1 with a new UUID and try again. Here <i>insert if not exists</i> should be
 * changed to update id if entity_key equals (the one we are specifying)</li>
 * </ul>
 * </li>
 * </ol>
 * 
