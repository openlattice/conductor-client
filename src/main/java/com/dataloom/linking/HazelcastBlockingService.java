...
public class HazelcastBlockingService {
    ...
    @Async
    public void blockAndMatch( GraphEntityPair graphEntityPair, LinkingEntity linkingEntity, Map<UUID, UUID> entitySetIdsToSyncIds, Map<FullQualifiedName, UUID> propertyTypeIdIndexedByFqn ) {
        ...
        linkingEntities.aggregate( new FeatureExtractionAggregator( graphEntityPair, linkingEntity, propertyTypeIdIndexedByFqn ), LinkingPredicates.entitiesFromKeysAndGraphId( eks, graphEntityPair.getGraphId() ) );
