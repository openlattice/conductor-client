 ...
 */
@Component
public class EntityBytesMergerStreamSerializer implements SelfRegisteringStreamSerializer<EntityBytesMerger> {
    @Override public Class<EntityBytesMerger> getClazz() {
        return EntityBytesMerger.class;
    }
    ...
    @Override public int getTypeId() {
        return StreamSerializerTypeIds.ENTITY_BYTES_MERGER.ordinal();
    }
